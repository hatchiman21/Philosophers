...
/*   Updated: 2025/01/04 23:15:18 by aatieh           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// void	grap_fork(t_philo_process *process)
// {
// 	while (1)
// 	{
// 		sem_wait(process->philo_data->fork[fork].mutex);
// 		if (process->philo_data->fork[fork].is_used == 0)
// 		{
// 			process->philo_data->fork[fork].is_used = 1;
// 			write_status(process, HELD_FORK);
// 			sem_post(process->philo_data->fork[fork].mutex);
// 			break ;
// 		}
// 		else
// 		{
...
// void	let_go_of_fork(t_philo_process *process)
// {
// 	sem_wait(process->philo_data->fork[fork].mutex);
