...
/*   Updated: 2024/12/27 22:24:29 by aatieh           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	philo_eat(t_philo_process *process)
{
	...
	pthread_mutex_unlock(&process->philo_data->fork[process->philo_num].mutex);
	pthread_mutex_unlock(&process->philo_data->fork[next_fork].mutex);
